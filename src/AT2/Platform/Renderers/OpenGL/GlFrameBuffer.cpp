...
void AT2::OpenGL::GlScreenFrameBuffer::SetClearColor(std::optional<glm::vec4> color) 
{
    m_clearColor = color;
}

void AT2::OpenGL::GlScreenFrameBuffer::SetClearDepth(std::optional<float> depth) 
{
    m_clearDepth = depth;
}
