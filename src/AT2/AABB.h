...
struct AABB2d
{
    ...
    [[nodiscard]] constexpr bool Valid() const noexcept { return MaxBound.x >= MinBound.x && MaxBound.y >= MinBound.y; }

    [[nodiscard]] constexpr bool Empty() const noexcept { return MaxBound.x == MinBound.x && MaxBound.y == MinBound.y; }
    ...
    [[nodiscard]] constexpr float GetWidth() const noexcept { return MaxBound.x - MinBound.x; }

    [[nodiscard]] constexpr float GetHeight() const noexcept { return MaxBound.y - MinBound.y; }

    [[nodiscard]] constexpr glm::vec2 GetSize() const noexcept { return MaxBound - MinBound; }
