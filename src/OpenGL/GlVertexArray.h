...
{
public:
	enum class BufferType : GLenum//TODO: Not full list of types!
	{
...
{
public:
	GlVertexBuffer(BufferType type, GLsizeiptr size, const T* data);
	~GlVertexBuffer();

	virtual BufferType GetType() { return m_type; }
